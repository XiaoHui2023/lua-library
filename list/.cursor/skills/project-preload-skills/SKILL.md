...
description: list 子库：会话预加载顺序与用过的 skill 记录。
---
...
5. `.cursor/skills/project-design-notes/SKILL.md`（monorepo 根）
6. `list/.cursor/skills/project-design-notes/SKILL.md`
7. `list/.cursor/skills/project-changelog/SKILL.md`
