...
root.factory.set_field("level", 2)
root.factory.add_field("tags", { prevent_duplicate = true })
...
assert_same(root.level(), 2, "factory set_field should assign created ref to owner")
root.tags.add("boss")
assert_same(root.tags().first(), "boss", "factory add_field should assign created collection to owner")
...
local stop_scope = root.factory.delete({ name = "stop_scope" })
